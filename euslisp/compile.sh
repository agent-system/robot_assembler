...
irteusgl "(progn (setq *error-handler* #'(lambda (&rest args) (unix::exit -1))) (comp::compile-file \"eus-yaml.l\") (exit))"
...
rm -f robot-assembler.{o,c,h} robot-assembler-utils.{o,c,h} robot-assembler-viewer.{o,c,h} eus-yaml.{o,c,h}
